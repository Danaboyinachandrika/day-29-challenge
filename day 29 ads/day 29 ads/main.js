(function () {
  ...
  set_dynamic_style_sheet_defferfix('font_awsome.css');
  set_dynamic_style_sheet_defferfix('bootstrap.min.css');
  set_dynamic_style_sheet_defferfix('main.css');
  set_dynamic_style_sheet_defferfix('responsive.css');
